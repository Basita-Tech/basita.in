        ...
        <div className="relative">
          ...
          <div className="space-y-16">
            {steps.map((step, index) => (
              ...
              >
                <div className="flex-shrink-0 w-16 h-16 rounded-full bg-[#0a0a0a] text-primary-foreground flex items-center justify-center font-serif text-xl font-bold relative z-10 md:absolute md:left-1/2 md:-translate-x-1/2">
                  {step.number}
                </div>
                ...
                >
                  <div className="bg-[#f5f5f5] p-8 rounded-2xl border border-border hover:border-primary/50 transition-colors">
