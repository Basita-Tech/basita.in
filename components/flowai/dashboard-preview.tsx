...
export function DashboardPreview() {
  ...
  function addProject() {
    ...
    setProjects((prev) => [
      { id: Date.now(), name: newName.trim(), status: "ongoing", paid: false },
      ...prev,
    ]);
    setNewName("");
    setOpen(false);
    toast({
      title: "Project added",
      description: "Your new project was created.",
    });
  }
  ...
  return (
    <section className="-mt-10">
      <div
        className={cn(
          "relative mx-auto max-w-5xl overflow-hidden rounded-3xl border bg-white shadow-md"
        )}
      >
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid gap-3">
            ...
            <p className="text-xs text-muted-foreground">
              Projects start as “ongoing”. You can cycle status and mark as paid
              from the list.
            </p>
          </div>
          <DialogFooter>
